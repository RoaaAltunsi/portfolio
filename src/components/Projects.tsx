...
function ProjectCard({
  ...
  return (
    <article
      ref={cardRef}
      className={[
        'grid min-h-[390px] w-[320px] max-[760px]:w-[min(78vw,320px)] flex-none cursor-pointer content-start rounded-lg border border-light bg-white px-[26px] pt-7 pb-6 text-left shadow-[0_24px_60px_rgba(0,0,0,0.11)] transition-[transform,box-shadow,border-color] duration-200 hover:-translate-y-1 hover:border-ink/35 hover:shadow-[0_30px_70px_rgba(0,0,0,0.16)] focus-visible:outline focus-visible:outline-offset-4 focus-visible:outline-ink',
        className,
      ].join(' ')}
      role="button"
      tabIndex={0}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        vectorEffect="non-scaling-stroke"
      />
      {/* Left-side upward flowing curve (connects from bottom-left toward cards) */}
      <path
  ...
  return (
    <>
      ...
      >
        ...
        {/* --------------------- Left side --------------------- */}
        <div className="relative z-2 max-w-[360px] self-center max-[1180px]:max-w-[620px] max-[760px]:max-w-[330px]">
          <SectionLabel>Projects</SectionLabel>

          <h2 className="max-w-[420px] font-serif text-[clamp(52px,6.5vw,100px)] leading-[0.9] font-medium max-[1180px]:max-w-[560px] max-[760px]:text-[clamp(44px,14vw,66px)]">
            Ideas
            <br />
            into
            <br />
          ...
          <span className="mt-3 mb-[34px] block h-[17px] w-[230px] rotate-[-5deg] rounded-[50%] border-b border-current opacity-70 max-[760px]:mb-6 max-[760px]:w-[190px]" />
        ...
        <div className="relative z-2 min-h-[720px] min-w-0 max-[1180px]:min-h-0 max-[760px]:mt-1">
          ...
          <div className="absolute top-0 right-[4%] z-10 flex gap-4 max-[1180px]:relative max-[1180px]:right-auto max-[1180px]:mb-5 max-[1180px]:justify-end max-[760px]:mb-3 max-[760px]:gap-3">
            <button
