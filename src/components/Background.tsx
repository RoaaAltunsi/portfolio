...
function SectionLabel({ children }: { children: string }) {
  return (
    <motion.div
      className="mb-8 flex items-center gap-4 text-xs font-medium tracking-[0.48em] uppercase max-[760px]:tracking-[0.32em]"
...
function IconBadge({ children }: { children: React.ReactNode }) {
  return (
    <motion.span
      className="grid h-14 w-14 place-items-center rounded-full border border-light bg-white/55 text-ink shadow-[0_10px_26px_rgba(0,0,0,0.025)]"
...
function BackgroundLinework() {
  const paths = [
    'M984 421 C1060 459 1117 417 1161 341 C1216 244 1362 249 1447 333',
    'M1015 276 C1114 314 1125 161 1246 155 C1377 149 1405 276 1518 220',
    'M1568 227 C1679 109 1765 124 1853 184 C1931 237 1986 226 2048 170',
    'M1548 641 C1646 535 1739 510 1820 560 C1896 607 1956 646 2048 510',
    'M1586 700 C1688 620 1764 633 1836 694 C1917 763 1980 744 2048 718',
  ]
...
function EducationCard() {
  ...
  return (
    <motion.article
      className="absolute right-[6.4%] top-[54%] z-4 w-[300px] rotate-6 rounded-2xl border border-light bg-white px-9 pt-11 pb-7 shadow-[0_24px_54px_rgba(0,0,0,0.10)] max-[1180px]:static max-[1180px]:w-full max-[1180px]:rotate-0"
      initial="hidden"
      whileInView="visible"
      viewport={VIEWPORT}
...
function CvCard() {
  ...
  return (
    <motion.div
      className="absolute left-[60%] top-[8%] z-5 h-[650px] w-[430px] -translate-x-1/2 rotate-[7deg] max-[1180px]:static max-[1180px]:h-auto max-[1180px]:w-full max-[1180px]:translate-x-0 max-[1180px]:rotate-0"
      initial="hidden"
      whileInView="visible"
      viewport={VIEWPORT}
      variants={slideFromRight}
      transition={t(0.9, 0.1)}
    >
      <motion.div
        className="absolute inset-0 translate-x-8 translate-y-4 rotate-2 rounded-2xl border border-light bg-paper-dark/55 shadow-[0_20px_56px_rgba(0,0,0,0.06)] max-[1180px]:hidden"
      ...
      <motion.article
        className="relative min-h-[650px] rounded-2xl border border-light bg-white px-[62px] pt-[74px] pb-[46px] shadow-[0_30px_78px_rgba(0,0,0,0.12)] max-[1180px]:min-h-[560px] max-[1180px]:px-10 max-[760px]:min-h-[500px] max-[760px]:px-7 max-[760px]:pt-12"
      ...
      >
        ...
        <motion.a
          ...
          target="_blank"
          href="/cv.pdf"
          whileHover={{ y: -3, boxShadow: '0 24px 48px rgba(0,0,0,0.28)' }}
          whileTap={{ scale: 0.97 }}
        >
...
export default function Background() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative z-3 max-w-[440px] pt-2 max-[1180px]:max-w-[620px]"
      ...
      >
        ...
        <motion.h2
          className="font-serif text-[clamp(58px,5.9vw,94px)] leading-[0.96] font-medium max-[760px]:text-[clamp(46px,14vw,66px)]"
          variants={fadeUp}
          transition={t(0.85)}
        >
          The foundation
        ...
        <motion.span
          className="mt-[-12px] block h-[18px] w-[380px] max-w-[62vw] -rotate-3 rounded-[50%] border-b border-current opacity-65 max-[760px]:ml-14 max-[760px]:mt-0"
          variants={fadeUp}
          transition={t(0.7, 0.12)}
        />

        <motion.p
          className="mt-[58px] max-w-[330px] text-[17px] leading-[1.75] text-mid tracking-wider max-[760px]:mt-8 max-[760px]:text-[15px]"
          variants={fadeUp}
      ...
      <motion.img
        ...
        whileInView={{ opacity: 0.78, x: 0, y: 0 }}
        viewport={VIEWPORT}
        transition={t(1, 0.2)}
      />
      ...
      <motion.img
        ...
        whileInView={{ opacity: 0.72, y: 0, rotate: 10 }}
        viewport={VIEWPORT}
